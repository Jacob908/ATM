        ...
        while True:
            ...
            # Transfer Savings Account to Checking Account
                ...
                if amt < accountObj.savingsAccountBalance():
                    ...
                    accountObj.transferCheckingAccount(amt)
                    # Printing updated balance
                    print(f"Updated checking account balance: ${format(accountObj.checkingAccountBalance(), '.2f')} ")
                    ...
                    print(
                        f"\nYour savings account balance is less than transfer amount: ${format(accountObj.checkingAccountBalance(), '.2f')} ")
                    time.sleep(2)
            ...
            # Transfer Checking Account to Savings Account
                ...
                if amt < accountObj.checkingAccountBalance():
                    ...
                    print(
                        f"\nYour checking account balance is less than transfer amount: ${format(accountObj.checkingAccountBalance(), '.2f')} ")
                    time.sleep(2)
